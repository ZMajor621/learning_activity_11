        ...
        body: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              pinned: true, //stays at top like standard app bar
              //floating: true,
              //snap: true,
              expandedHeight: 200,
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
          (BuildContext context, int index) {
            DailyForecast dailyForecast = Server.getDailyForecastByID(index);
            return Card(
              child: Row(
                children: [
                  SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        DecoratedBox(
                          ...
                          child:
                          Image.network(dailyForecast.imageId, fit: BoxFit.cover),
                        ),
                        Center(
                          child: Text(
